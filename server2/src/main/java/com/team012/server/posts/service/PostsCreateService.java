...
public class PostsCreateService {
    ...
    public void createPostsResponse(PostsCreateDto postsCreateDto, List<MultipartFile> images, Long usersId){
    ...
    private void savePostsHashTags(PostsCreateDto postsCreateDto, Posts posts) {
        ...
        tagService.saveCompanyPostsTags(tags, posts);
    }

    private void savePostsServiceTag(PostsCreateDto postsCreateDto, Posts posts) {
